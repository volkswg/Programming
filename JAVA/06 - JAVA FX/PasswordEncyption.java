...
public class PasswordEncyption {
	private byte[] salt;
	public PasswordEncyption() throws NoSuchAlgorithmException, NoSuchProviderException {
		this.salt = getSalt();
	}
	
	public String genPassHash(String passwordIn) {
		return getSecurePassword(passwordIn, this.salt);
	}
